...
module.exports = {
    dev: {
        ...
        assetsPublicPath: webpacConfig.dev.assetsPublicPath || '/',
        proxyTable: webpacConfig.dev.proxyTable || {},
    ...
    build: {
        ...
        assetsSubDirectory: 'static',
        assetsPublicPath: webpacConfig.build.assetsPublicPath || '/',

        /**
         * Source Maps
         */

        productionSourceMap: buildtype == 'pro' ? false : true,
        ...
        productionGzip: buildtype == 'pro' ? true : false,
